...
delete from tp_pregunta_evaluacion_regla where cod_evaluacion in ('EV20151205203902');
delete from tp_pregunta_evaluacion where cod_evaluacion in ('EV20151205203902');
delete from tp_evaluacion_acoso_escolar where cod_evaluacion in ('EV20151205203902');
delete from tp_alumno_evaluado where cod_alumno in ('A201500098');
...
--A201500098 | P0002
insert into tp_evaluacion_acoso_escolar (cod_evaluacion, cod_plantilla, fec_resuelto,cod_alumno,cod_perfil,cod_estado) values ('EV20151205203902', 'PTEV0001', '30/03/2016', 'A201500098', null,'EVA0001');
...
where a.cod_alumno in ('A201500098');
...
inner join tp_estado c on a.cod_estado = c.cod_estado
left join tp_perfil b on a.cod_perfil=b.cod_perfil
where a.cod_evaluacion in ('EV20151205203902');
...
where a.cod_evaluacion in ('EV20151205203902') and seleccionado
