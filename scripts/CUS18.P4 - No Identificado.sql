...
delete from tp_pregunta_evaluacion_regla where cod_evaluacion in ('EV20151205203904');
...
--A201500096 | 
insert into tp_evaluacion_acoso_escolar (cod_evaluacion, cod_plantilla, fec_resuelto,cod_alumno,cod_perfil,cod_estado) values ('EV20151205203904', 'PTEV0001', '30/03/2016', 'A201500096', null,'EVA0001');
...
where a.cod_evaluacion in ('EV20151205203904') and seleccionado
