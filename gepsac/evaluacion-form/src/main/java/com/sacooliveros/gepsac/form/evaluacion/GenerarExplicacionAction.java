 ...
 * @author rcastillejo
 */
public class GenerarExplicacionAction extends DispatchAction {

    private static final Logger logger = LoggerFactory.getLogger(GenerarExplicacionAction.class);
    ...
    public GenerarExplicacionAction() {
    ...
    public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        return mapping.findForward("listarAcosoEscolar");
    }

    public ActionForward initExplicacion(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        return mapping.findForward("explicacionAcosoEscolar");
    }
